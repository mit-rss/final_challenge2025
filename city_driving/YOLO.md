...
```bash
python3 city_driving/model/detector.py 
```
which will save the output image with bounding boxes (as below) to `city_driving/model/output.jpg`. 
